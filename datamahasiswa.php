...
if (isset($_POST["act"])) {
    ...
    switch ($act) {
        case "store":
            ...
            $sql = "INSERT INTO tbmahasiswa (nama, nim, jurusan, alamat) VALUES ('$nama', '$nim', '$jurusan', '$alamat');";
        ...
        case "update":
            ...
            $sql = "UPDATE tbmahasiswa SET nama='$nama', nim='$nim', jurusan='$jurusan', alamat='$alamat' WHERE idmahasiswa='$idmahasiswa';";
            $hasil = mysqli_query($cnn, $sql);
            if ($hasil) {
                $footer = "<script>
                    Swal.fire({
        ...
        case "destroy":
            $idmahasiswa = $_POST['idmahasiswa'];
            $sql = "DELETE FROM tbmahasiswa WHERE idmahasiswa='$idmahasiswa';";
            $hasil = mysqli_query($cnn, $sql);
            if ($hasil) {
                $footer = "<script>
                    Swal.fire({
